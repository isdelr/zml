...
ARG NEXT_PUBLIC_MEDIA_DELIVERY_BASE_URL
ARG MEDIA_DELIVERY_BASE_URL
...
ENV NEXT_PUBLIC_MEDIA_DELIVERY_BASE_URL=$NEXT_PUBLIC_MEDIA_DELIVERY_BASE_URL
ENV MEDIA_DELIVERY_BASE_URL=$MEDIA_DELIVERY_BASE_URL
