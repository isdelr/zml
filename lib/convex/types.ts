...
export type LeagueData = NonNullable<
  FunctionReturnType<typeof api.leagues.get>
>;
...
>["page"][number];
export type SubmissionForRound = FunctionReturnType<
...
>;
export type SongLinkMetadata = FunctionReturnType<
  typeof api.submissions.getSongMetadataFromLink
>;
export type BookmarkedSong = FunctionReturnType<
  typeof api.bookmarks.getBookmarkedSongs
>[number];
export type UserVoteStatus = FunctionReturnType<
  typeof api.votes.getForUserInRound
>;
