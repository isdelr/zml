...
export function HomeHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:px-24 px-2 pt-[env(safe-area-inset-top)]">
