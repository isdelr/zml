      ...
      <main className="flex-1">
        ...
        >
           <div className="p-6 bg-card border rounded-lg space-y-4">
               <div className="flex justify-between items-center">
                   ...
                   <span className="text-xs px-2 py-1 rounded-full bg-primary/10 text-primary font-medium">Voting Active</span>
               </div>
               <div className="flex items-center gap-4 p-3 bg-accent rounded-md">
                ...
                <div className="flex items-center gap-4 p-3 bg-accent/50 rounded-md">
                   <Music className="size-8 text-muted-foreground" />
                   <div className="flex-1">
                       <p className="font-semibold text-foreground">Smells Like Teen Spirit</p>
        ...
        >
           <div className="p-6 bg-card border rounded-lg space-y-4">
               ...
               <p className="text-sm text-muted-foreground">Discover and save new favorites from every round.</p>
